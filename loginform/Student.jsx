        ...
        <h2>Registration Form</h2>
            <form>
                <table>
                    ...
                    <tr>
                        <td><input type="radio" name="gender" value="Male" onChange={(e)=>SetGener(e.target.value)}/>Male </td>
                        <td><input type="radio" name="gender" value="Female" onChange={(e)=>SetGener(e.target.value)}></input>Female</td>
                    </tr>
                    <tr>
                        <td>Country</td>
                        <td>
